...
class MetricOptions:
    def __init__(self, G=None, G_kwargs={}, dataset_kwargs={}, num_gpus=1, rank=0, rank_gpu_map = None, device=None, progress=None, cache=True):
        ...
        self.rank           = rank
        self.device         = device if device is not None else torch.device('cuda', rank_gpu_map[rank])
