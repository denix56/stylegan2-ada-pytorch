...
class StyleGAN2(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        for i, (name, module, opt_kwargs,
                reg_interval, loss_) in enumerate([('G', self.G, self.G_opt_kwargs, self.G_reg_interval, self._gen_loss),
                                                  ('D', self.D, self.D_opt_kwargs, self.D_reg_interval, self._disc_loss)]):
