...
class StyleGAN2(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        for i, (name, module, opt_kwargs,
                reg_interval, loss_) in enumerate([('G', self.G, self._G_opt_kwargs, self.G_reg_interval, self._loss1),
                                                   ('D', self.D, self._D_opt_kwargs, self.D_reg_interval, self._loss2)
        ]):
